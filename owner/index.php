...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12" style="background-color:lightsalmon;" >
            <h4 align="center" class="page-title">Dashboard</h4> </div>
    </div>
    <div class="row">
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info" style="background-color:peru;">
                <h3 align="center" class="box-title">Oulet</h3>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info" style="background-color:peru;">
                <h3 align="center" class="box-title">Pelanggan</h3>
                <ul class="list-inline two-part">
                    <li>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info" style="background-color:peru;">
                <h3 align="center" class="box-title">Transaksi</h3>
                <ul class="list-inline two-part">
                    <li>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12col-sm-12">
            <div class="white-box"  style="background-color:sienna" >
                <h3 class="box-title" style="color: white;">10 Transaksi Terbaru</h3>
                    ...
                    <table class="table " >
                        <thead >
                            <tr >
                                ...
                                <th style="color: white;">Pemabayaran</th>
                                <th style="color: white;">Total Harga</th>
                                <th style="color: white;" align="center">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $no=1; foreach($data as $transaksi): ?>
                                <tr style="color: white;">
                                    ...
                                    <td align="center">
                                          <a style="background-color:chocolate;" href="transaksi_detail.php?id=<?= $transaksi['id_transaksi']; ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" class="btn btn-success btn-block">Detail</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
