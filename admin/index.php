...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12" align="center">
            <h4 class="page-title" style="background-color: lightcoral;">Dashboard</h4> </div>
    </div>
    <div class="row">
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info">
                <h3 class="box-title"  align="center" style="background-color: lightcoral;">Oulet</h3>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info">
                <h3 class="box-title" style="background-color: lightcoral;" align="center">Pelanggan</h3>
                <ul class="list-inline two-part">
                    <li>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info">
                <h3 class="box-title" style="background-color: lightcoral;" align="center">Transaksi</h3>
                <ul class="list-inline two-part">
                    <li>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box">
                <h3 class="box-title" align="center" style="background-color: lightcoral;">10 Transaksi Terbaru</h3>
