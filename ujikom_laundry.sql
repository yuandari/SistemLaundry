...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Nov 2022 pada 10.26
...
(602, 502, 401, 1, 6000, NULL, 6000),
(603, 502, 402, 3, 18000, NULL, NULL),
(604, 502, 402, 2, 12000, NULL, NULL);
...
(301, 'Yeni Sentia', 'Komarudin 2, Bandar Lampung', 'P', '086545440099', '1804117698769991'),
(302, 'Rina ', 'Bataranila 02, Bandar Lampung', 'P', '085576787654', '1806554387867765');
...
(201, 'Outlet Laundry 1', 'Kemiling, Bandar Lampung', '085658298877'),
(202, 'Outlet Laundry 2', 'Rajabasa, Bandar Lampung', '0856582996755');
...
(401, 'kiloan', 'Cuci kering', 6000, 201),
(402, 'kiloan', 'Cuci kering', 6000, 202);
...
(502, 201, 'Laun20221115', 301, '2022-11-15 05:15:53', '2022-11-22 12:00:00', '2022-11-15 05:16:43', 0, 0, 0, 'selesai', 'dibayar', 2),
(503, 202, 'Laun20221115', 302, '2022-11-15 05:19:53', '2022-11-22 12:00:00', NULL, 2000, 0, 0, 'baru', 'belum', 3),
(504, 202, 'Laun20221115', 302, '2022-11-15 05:20:46', '2022-11-22 12:00:00', NULL, 0, 0, 0, 'baru', 'belum', 3);
...
(2, 'Melisa', 'melisa', '9bd3e6bf8599bc2f31f3f22a16725059', 201, 'kasir'),
(3, 'Lulu', 'lulu', '654e4dc5b90b7478671fe6448cab3f32', 202, 'kasir'),
(4, 'Warsih', 'warsih', 'd41d8cd98f00b204e9800998ecf8427e', 201, 'owner'),
(5, 'Yuni', 'yuni', 'd41d8cd98f00b204e9800998ecf8427e', 202, 'owner');
...
--
ALTER TABLE `detail_transaksi`
  MODIFY `id_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=605;

--
-- AUTO_INCREMENT untuk tabel `member`
--
ALTER TABLE `member`
  MODIFY `id_member` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=303;

--
-- AUTO_INCREMENT untuk tabel `outlet`
--
ALTER TABLE `outlet`
  MODIFY `id_outlet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=203;

--
-- AUTO_INCREMENT untuk tabel `paket`
--
ALTER TABLE `paket`
  MODIFY `id_paket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=403;

--
-- AUTO_INCREMENT untuk tabel `transaksi`
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=505;
