...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12" style="background-color:darkslategray;">
            <h4 class="page-title" align="center" style="color:white;">Dashboard</h4> 
        </div>
    </div>
    <div class="row">
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info" style="background-color:darkolivegreen;">
                <h3 class="box-title" align="center" style="color:white;">Penghasilan Tahun Ini</h3>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info" style="background-color:darkolivegreen;">
                <h3 class="box-title" align="center" style="color:white;">Penghasilan Bulan ini</h3>
                <ul class="list-inline two-part">
                    <li>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="white-box analytics-info" style="background-color:darkolivegreen;">
                <h3 class="box-title" align="center" style="color:white;">Penghasilan Minggu Ini</h3>
                <ul class="list-inline two-part">
                    <li>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="white-box" >
                <h3  class="box-title" style="background-color:darkolivegreen;color:white;" align="center">Laporan Penjualan Paket</h3>
