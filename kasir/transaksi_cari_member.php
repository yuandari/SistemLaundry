...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12" style="background-color:darkslategray;">
            <h4 class="page-title" align="center" style="color:white;">Pilih Pelanggan</h4> </div>
                        ...
                        <tbody>
                            <?php foreach($data as $member): ?>
                                <tr>
                                    ...
                                    <td><?= $member['no_ktp'] ?></td>
                                    <td align="center">
                                          <a style="background-color:darkgreen"href="transaksi_tambah.php?id=<?= $member['id_member']; ?>" data-toggle="tooltip" data-placement="bottom" title="Pilih" class="btn btn-primary btn-block">PILIH</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
