...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12" style="background-color:darkslategray;">
            <h4 class="page-title" align="center" style="color:white;">Data Transaksi</h4> </div>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                ...
                <div class="text-right">
                    <button style="background-color:darkolivegreen;" type="submit" name="btn-simpan" class="btn btn-primary">Ubah</button>
                </div>
                </form>
            </div>
        </div>
