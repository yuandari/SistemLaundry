    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part" style="background-color:darkslategray;">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a style="background-color:darkslategray;" class="profile-pic" href="#"> <img src="../assets/images/adm1.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">KASIR</b></a>
                    </li>
                </ul>
            </div>
        </nav>
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <div class="center p-20">
                     <a style="background-color:darkslategray;" href="logout.php" class="btn btn-danger btn-block waves-effect waves-light">Logout</a>
                 </div>
            </div>
